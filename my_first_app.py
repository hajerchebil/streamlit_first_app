...
# st.cache is a cache mechanism in order to avoid recomputing
# cached => data is only downloaded once => recomputed if only sthhg is changed in the input
@st.cache
def read_csv(path):
...
housing_price_df=read_csv('/home/hajer/Desktop/Arbeit/data_science/streamlit_app/state_market_tracker.tsv000.gz')
...
gdf = read_file('/home/hajer/Desktop/Arbeit/data_science/streamlit_app/us-state-boundaries.geojson')
#st.write(gdf.head())
